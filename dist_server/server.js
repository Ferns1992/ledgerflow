...
const logEvent = (userId, userName, action, entityType, entityId, details) => {
    try {
...
async function startServer() {
    ...
    app.post('/api/companies', (req, res) => {
        ...
        try {
            ...
            logEvent(userId, userName, 'CREATE', 'COMPANY', result.lastInsertRowid, `Created company: ${name}`);
    ...
    app.post('/api/ledgers', (req, res) => {
        ...
        logEvent(userId, userName, 'CREATE', 'LEDGER', result.lastInsertRowid, `Created ledger: ${name}`);
        res.json({ id: result.lastInsertRowid });
    });
    ...
    app.post('/api/taxes', (req, res) => {
        ...
        logEvent(userId, userName, 'CREATE', 'TAX', result.lastInsertRowid, `Created tax: ${name}`);
        res.json({ id: result.lastInsertRowid });
    });
    ...
    app.post('/api/transactions', (req, res) => {
        ...
        logEvent(userId, userName, 'CREATE', 'TRANSACTION', result.lastInsertRowid, `Created transaction: ${amount} Dr ${debit_ledger_id} Cr ${credit_ledger_id}`);
        res.json({ id: result.lastInsertRowid });
    });
    ...
    app.post('/api/assets', (req, res) => {
        ...
        logEvent(userId, userName, 'CREATE', 'ASSET', result.lastInsertRowid, `Created asset: ${name}`);
        res.json({ id: result.lastInsertRowid });
    });
    ...
    app.post('/api/users', (req, res) => {
        ...
        try {
            ...
            logEvent(userId, userName, 'CREATE', 'USER', result.lastInsertRowid, `Created user: ${username}`);
            res.json({ id: result.lastInsertRowid });
        }
        catch (e) {
